...
public class FacebookFriendsAdapter extends 	android.support.v4.widget.CursorAdapter implements OnCheckedChangeListener,SectionIndexer{
	...
	public FacebookFriendsAdapter(Context context, Cursor c, AlphabetIndexer indexer,
