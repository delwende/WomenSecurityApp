...
public class SearchableActivity extends ActionBarActivity implements  LoaderCallbacks<Cursor> {
	...
	public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
		if (Intent.ACTION_SEARCH.equals(getIntent().getAction())) {
			 return new CursorLoader(this, ContentDescriptor.WSFacebook.CONTENT_URI, null, ContentDescriptor.WSFacebook.Cols.FBNAME+" like ? ", new String[]{searchquery+"%"}, null);
	...
	private void sortUsingSectionIndexor(final Cursor mCursor ) {
		...
		mTask = new AsyncTask<Void, Void, Integer>() {
			...
			protected void onPostExecute(Integer params) {
				...
				if (adapter == null) {
					adapter = new FacebookFriendsAdapter(SearchableActivity.this, mCursor, indexer, usedSectionNumbers,sectionToOffset, sectionToPosition);
